...
public class AddAgentDataPage {
	...
	public static WebElement Drpdown_AgentName(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element = driver.findElement(parser.getLocator("AgentName"));
	    return element;
}
