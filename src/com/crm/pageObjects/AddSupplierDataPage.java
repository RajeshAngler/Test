...
public class AddSupplierDataPage {
	...
	public static WebElement Drpdown_SupplierName(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element = driver.findElement(parser.getLocator("SupplierName"));
	    return element;
}
	...
	public static WebElement Grid_SupplierName(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_CompanyName_Su"));
		return element;
		}
	public static WebElement Grid_ContactName(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_ContactName_Su"));
		return element;
		}
	public static WebElement Grid_Email(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_Email_Su"));
		return element;
		}
	public static WebElement Grid_Department(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_Department_Su"));
		return element;
		}
	public static WebElement Grid_Designation(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_Designation_Su"));
		return element;
		}
	...
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_ContactType_Su"));
		return element;
		}
	public static WebElement Grid_Status(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_Status_Su"));
		return element;
		}
	public static WebElement chk_Grid_SupplierTitle(WebDriver driver) throws IOException
	{
		parser.RepositoryParser(Constants.path_ObjectRepo);
		element=driver.findElement(parser.getLocator("Grid_SupplierTitle"));
		return element;
		}
}
